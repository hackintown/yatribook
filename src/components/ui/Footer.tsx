...
const Footer = () => {
    const bettingSites1 = [
        "Mahakal Online Book", "Reddy Anna Book", "Tiger Exchange 247",
        "Silver Exchange", "Diamond Exchange ID", "Lotus365",
        "4RaBet", "Funbet", "Indibet", "Satfair"
    ];

    const bettingSites2 = [
        "Ambani Book", "Mahadev Online Book", "Betbhai9",
        "IPL Betting ID", "Betting Satta ID", "Casino ID",
        "Rajbet", "Lords Exchange", "Satsport247", "Yolo247"
    ];
                ...
                <div className="container">
                    <div className="flex items-center justify-center gap-3 text-accent-red">
                        ...
                        <p className="text-sm md:text-base font-medium">
                            Gambling can be addictive. Please play responsibly and at your own risk.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="container py-16 relative">
                ...
                <div className="text-center mb-16 relative">
                    ...
                    <p className="text-lg text-foreground/80 max-w-2xl mx-auto">
                        YATRI Book is the most Trusted Betting Exchange and Leading Online Casino.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 relative">
                    ...
                    <div className="space-y-6">
                        ...
                        <ul className="space-y-3">
                            {['Contact us', 'About us', 'Terms & conditions', 'Privacy Policy', 'Blog'].map((item) => (
                                <li key={item}>
                                    <Link
                                        href="#"
                                        className="text-sm lg:text-base text-foreground/70 hover:text-primary transition-all duration-300 flex items-center gap-2 group"
                    ...
                    <div className="space-y-6">
                        ...
                        <ul className="space-y-4">
                            {[
                                { icon: Phone, text: "+91-9310764844", href: "tel:+919310764844" },
                                { icon: MessageCircle, text: "WhatsApp", href: "https://wa.me/919310764844", className: "text-whatsapp" },
                                { icon: Send, text: "Telegram", href: "#", className: "text-telegram" }
                            ].map((item) => (
                                <li key={item.text}>
                                    <Link
                                        href={item.href}
                ...
                <div className="mt-16 py-6 border-t border-primary/10">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                        <p className="text-sm text-foreground/50">
                            © {new Date().getFullYear()} Yatri Book. All rights reserved.
                        </p>
