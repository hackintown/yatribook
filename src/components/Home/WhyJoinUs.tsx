...
const reasons = [
  {
    ...
    description:
      "Yatribook offers secure and reliable Online Cricket ID with attractive offers. Our platform ensures complete safety of your transactions and personal information.",
  },
  {
    icon: Users,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[35%,60%] gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-base lg:text-lg font-light text-center md:text-left text-foreground/80">
              ...
              with Yatribook. We offer the best odds, instant withdrawals, and
