...
const instagramPosts: InstagramPost[] = [
    {
        id: "1",
        imageUrl: "https://amiribook.com/wp-content/uploads/al_opt_content/IMAGE/amiribook.com/wp-content/uploads/2024/11/inst5_11zon.webp.bv.webp",
        caption: "Match predictions for today's IPL game! 🏏 #CricketBetting #IPL2023",
        likes: 245,
        comments: 32,
        postUrl: "https://amiribook.com/wp-content/uploads/al_opt_content/IMAGE/amiribook.com/wp-content/uploads/2024/11/inst2_11zon.webp.bv.webp",
        date: "2h ago",
    },
    {
        id: "2",
        imageUrl: "https://amiribook.com/wp-content/uploads/al_opt_content/IMAGE/amiribook.com/wp-content/uploads/2024/11/inst3_11zon.webp.bv.webp",
        caption: "Our expert analysis was spot on! Check out today's winning tips 💰 #BettingTips",
        likes: 189,
        comments: 24,
    ...
    {
        id: "3",
        imageUrl: "https://amiribook.com/wp-content/uploads/al_opt_content/IMAGE/amiribook.com/wp-content/uploads/2024/11/inst1_11zon.webp.bv.webp",
        caption: "Last minute odds update for the T20 World Cup! 🌍 #T20WorldCup #CricketOdds",
        likes: 312,
        comments: 45,
    ...
    },
    {
        id: "4",
        imageUrl: "https://amiribook.com/wp-content/uploads/al_opt_content/IMAGE/amiribook.com/wp-content/uploads/2024/11/inst5_11zon.webp.bv.webp",
        caption: "Player spotlight: Who to watch in tomorrow's match 🔍 #PlayerAnalysis",
        likes: 276,
        comments: 38,
    ...
    {
        id: "5",
        imageUrl: "https://amiribook.com/wp-content/uploads/al_opt_content/IMAGE/amiribook.com/wp-content/uploads/2024/11/inst4_11zon.webp.bv.webp",
        caption: "Weekend special: Double your winnings on selected matches! 💯 #SpecialOffer",
        likes: 421,
        comments: 67,
    ...
    {
        id: "6",
        imageUrl: "https://amiribook.com/wp-content/uploads/al_opt_content/IMAGE/amiribook.com/wp-content/uploads/2024/11/inst2_11zon.webp.bv.webp",
        caption: "Cricket history in the making! Record-breaking performance yesterday 🏆 #CricketHistory",
        likes: 532,
        comments: 91,
            ...
            <div className="container">
                <div className="flex items-center justify-between mb-8">
                    ...
                    >
                        ...
                        <span className="hidden sm:inline text-foreground/90">Follow us</span>
                    </Link>
                </div>
                    ...
                    <Slider {...settings}>
                        {instagramPosts.map((post) => (
                            <div key={post.id} className="px-2">
                                <Link href={post.postUrl} target="_blank" rel="noopener noreferrer" className="block">
                                        ...
                                        <div className="p-4 bg-surface-light/50">
                                            <div className="flex items-center justify-between text-sm text-foreground/70">
                                                <div className="flex items-center space-x-4">
                                                    ...
                                                    <span className="flex items-center">
                                                        <svg className="w-4 h-4 mr-1 text-secondary" fill="currentColor" viewBox="0 0 24 24">
