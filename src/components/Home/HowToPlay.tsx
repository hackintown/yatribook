            ...
            <div className="container relative z-10">
                <div className="text-center mb-16">
                    ...
                    <p className="text-foreground/60 max-w-2xl mx-auto mt-4">
                        Follow these simple steps to join our gaming community and start winning
                    </p>
                </div>
                        ...
                        >
                            <div className="bg-gaming-gray/50 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-primary/20 hover:-translate-y-2 transition-all duration-300 border border-primary/10 group">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-br opacity-0 group-hover:opacity-5 transition-opacity duration-300 rounded-2xl"
                                    style={{
                                        background: `linear-gradient(45deg, var(--${step.gradientFrom.split('-')[1]}), var(--${step.gradientTo.split('-')[1]}))`
                                    }}
                                />
                                
                                <div className="flex justify-center mb-6 relative">
                                    <div className={`bg-gradient-to-br ${step.gradientFrom} ${step.gradientTo} p-0.5 rounded-full group-hover:scale-105 transition-transform duration-300`}>
                                ...
                                <div className="absolute -top-6 -right-6 w-16 h-16 rounded-full bg-surface-light flex items-center justify-center text-5xl font-black group-hover:scale-110 transition-transform duration-300"
                                    style={{
                                        background: `linear-gradient(45deg, var(--${step.gradientFrom.split('-')[1]}), var(--${step.gradientTo.split('-')[1]}))`
                                    }}>
                ...
                <div className="mt-16 text-center">
                    <Link href="https://wa.me/919310764844" passHref>
                        <Button
                            variant="primary"
                            size="xl"
                            className="rounded-full bg-gradient-to-r from-whatsapp to-accent-green hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-whatsapp/20"
